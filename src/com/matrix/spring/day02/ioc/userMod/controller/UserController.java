package com.matrix.spring.day02.ioc.userMod.controller;
...
/**
 *
 * 非常非常非常非常非常非常非常非常非常非常非常非常非常非常非常非常非常重要！！！！！！！！！
 *
 * 基于注解的组件化管理：
...
@Controller // @Controller(value = "aaa") 通过value属性设置自定义bean的id
public class UserController {

    @Autowired // 默认根据类型byType进行自动装配 可以自动切换 如果byType 不行就 byName
    private UserService userService;  // UserService userService = new UserServiceImpl() 其中的new UserServiceImpl()相当于@Autowired
